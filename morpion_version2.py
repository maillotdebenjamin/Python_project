...
def est_gagnant(grille):
    ...
    if (grille[8]==grille[15]) and (grille[8]==grille[22]) and (grille[8]==grille[29]) and (grille[8]!=" "):
        return 1
    if (grille[15]==grille[22]) and (grille[15]==grille[29]) and (grille[36]==grille[3]) and (grille[15]!=" "):
        return 1
    ...
    if (grille[9]==grille[16]) and (grille[9]==grille[23]) and (grille[9]==grille[30]) and (grille[9]!=" "):
        return 1
    if (grille[16]==grille[27]) and (grille[16]==grille[30]) and (grille[16]==grille[37]) and (grille[16]!=" "):
        return 1
    
    if (grille[3]==grille[10]) and (grille[3]==grille[17]) and (grille[3]==grille[24]) and (grille[3]!=" "):
        return 1
    if (grille[10]==grille[17]) and (grille[10]==grille[24]) and (grille[10]==grille[30]) and (grille[10]!=" "):
        return 1
    ...
    if (grille[6]==grille[13]) and (grille[6]==grille[20]) and (grille[6]==grille[25]) and (grille[27]!=" "):
        return 1
    if (grille[13]==grille[20]) and (grille[13]==grille[27]) and (grille[13]==grille[34]) and (grille[31]!=" "):
        return 1
    if (grille[20]==grille[27]) and (grille[20]==grille[34]) and (grille[20]==grille[41]) and (grille[20]!=" "):
        return 1
    
    if (grille[21]==grille[15]) and (grille[21]==grille[9]) and (grille[21]==grille[3]) and (grille[21]!=" "):
        return 1
    if (grille[28]==grille[22]) and (grille[28]==grille[16]) and (grille[28]==grille[10]) and (grille[28]!=" "):
        return 1
    if (grille[22]==grille[16]) and (grille[22]==grille[10]) and (grille[22]==grille[4]) and (grille[22]!=" "):
        return 1
    
    if (grille[35]==grille[29]) and (grille[35]==grille[23]) and (grille[35]==grille[17]) and (grille[35]!=" "):
        return 1
    if (grille[29]==grille[23]) and (grille[29]==grille[17]) and (grille[29]==grille[11]) and (grille[29]!=" "):
        return 1
    if (grille[23]==grille[17]) and (grille[23]==grille[11]) and (grille[23]==grille[5]) and (grille[23]!=" "):
        return 1
    
    if (grille[36]==grille[30]) and (grille[36]==grille[24]) and (grille[36]==grille[18]) and (grille[36]!=" "):
        return 1
    if (grille[30]==grille[24]) and (grille[30]==grille[18]) and (grille[30]==grille[12]) and (grille[30]!=" "):
        return 1
    if (grille[24]==grille[18]) and (grille[24]==grille[12]) and (grille[24]==grille[6]) and (grille[24]!=" "):
        return 1
    
    if (grille[37]==grille[31]) and (grille[37]==grille[25]) and (grille[37]==grille[19]) and (grille[37]!=" "):
        return 1
    if (grille[31]==grille[25]) and (grille[31]==grille[19]) and (grille[31]==grille[13]) and (grille[31]!=" "):
        return 1
    if (grille[38]==grille[32]) and (grille[38]==grille[26]) and (grille[38]==grille[20]) and (grille[38]!=" "):
        return 1
